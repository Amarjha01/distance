  ...
  return (
    <div className="relative bg-teal-900 py-12 overflow-hidden">
      <div className="w-full h-auto bg-amber-600 flex justify-center items-center">
        <div className="absolute bg-gradient-to-br from-blue-50 to-indigo-100 h-[300vw] w-[300vw] rounded-[150Vw] z-10 -translate-y-[48.2%]" />
      </div>
      ...
      <div className="px-4 md:px-10 py-10 relative z-20">
        <Slider {...settings}>
          {coursesData.map((course) => {
            const Icon = iconMap[course.icon] || FaClock;
            ...
            return (
              <div key={course.id} className="px-2 h-full">
                ...
                >
                  <div className="flex justify-center mb-4 text-teal-700 text-3xl">
                    <Icon />
                  </div>
